...
\item
Careful {\tt EVAL-WHEN} discipline needed (as with ASDF really, but now it is enforced).
...
\begin{itemize}
\item
xcvb-dependency-check to detect superfluous dependencies
(to be based on asdf-dependency-grovel).
...
yet the bulk of the work is still ahead.
That's how far behind other languages
...
under the guidance of François-René Rideau.
Rideau briefly worked on it in mid December 2008
to get a semi-usable prototype released.
...
\center{\tt \href{http://common-lisp.net/projects/xcvb/}{http://common-lisp.net/projects/xcvb/}}
...
Many thanks to James Knight for his many essential insights,
and to Juho Snellman for implementing CFASL support in SBCL.
