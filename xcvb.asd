...
deterministic separate compilation and enforced locally-declared dependencies."
    ...
    ((:file "pkgdcl")
     ...
     (:file "registry" :depends-on ("portablish-pathnames" "grains" "specials"))
     (:file "computations" :depends-on ("grains" "registry" "specials"))
     ...
     (:file "farmer" :depends-on ("specials" "lisp-grain" "dependencies-interpreter"))
