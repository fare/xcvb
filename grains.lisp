...
(defclass persistent-grain (grain)
  ()
  (:documentation "Files and other persistent data intent")
(defclass transient-grain (grain)
  ()
  (:documentation "Active computational intent")
(defclass phony-grain (grain)
  ()
  (:documentation "Other intent")

(defclass file-grain (persistent-grain)
  () ;name, type, etc.
